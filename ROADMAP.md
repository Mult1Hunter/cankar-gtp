...
- ⚠️ **Licensing (B5):** publish reproducible corpus-*building scripts*, not the merged corpus
...
- Reference: total compute ≈ 50–100× *less* than nanochat's $100 speedrun; budget anxiety = zero
...
- [ ] ⚠️ **Distribution-shift fix (A1):** ONE shared "plain Slovene register" prompt, reused verbatim for
...
> ⚠️ **Open decision (parked 2026-07, due at this phase's go/no-go): web stack.**
